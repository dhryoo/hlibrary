 ...
 */
angular.module('hl4App').controller('LoginCtrl', ['$scope','$rootScope','AUTH_EVENTS','AuthService','Session','$modalInstance',function ($scope,$rootScope,AUTH_EVENTS,AuthService,Session,$modalInstance)
{
    $scope.credentials =
    {
        username:'',
